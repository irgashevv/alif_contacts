                ...
                <?php if ($_GET['action'] !== 'create'): ?>
                    <?php foreach ($result['phone_numbers'] as $key => $number): ?>
                        ...
                        <div class="form-group d-flex">
                            ...
                            <a href="/?model=contacts&action=deletePhones&id=<?=$phone_value?>&contact_id=<?=$_GET['id']?>" class="btn btn-danger ml-2">Delete</a>
                            <?php if ($key == 0): ?>
                ...
                <?php if ($_GET['action'] !== 'create'): ?>
                    <?php foreach ($result['emails'] as $key => $email) : ?>
                        ...
                        <div class="form-group d-flex">
                            ...
                            <a href="/?model=contacts&action=deleteEmails&id=<?=$email_value?>&contact_id=<?=$_GET['id']?>" class="btn btn-danger ml-2">Delete</a>
